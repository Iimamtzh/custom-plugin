...
class Shortcode
{
    ...
    public function __construct()
    {
        ...
        add_shortcode('layanan_harga', array($this, 'layanan_harga_shortcode'));
...
<?php
    ...
    public function layanan_harga_shortcode($atts)
    {
        $atts = shortcode_atts(
            array(
                'id' => get_the_ID(),
        ...
        $harga = get_post_meta($post_id, '_layanan_harga', true);

        return esc_html($harga);
    }
}
